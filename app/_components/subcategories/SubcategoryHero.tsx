...
/**
 * A hero component that displays information about a subcategory.
 * @param subcategory - The subcategory to display.
 */
export default function SubcategoryHero({
	subcategory,
}: {
	subcategory: FullSubcategoryType;
}) {
	return (
		<div className="rounded-xl bg-black">
			<div
				...
				style={{
					backgroundColor: subcategory.color ? subcategory.color : undefined,
				}}
			>
				{subcategory.image_url_hero ? (
					<SupabaseImage
						dbImageUrl={subcategory.image_url_hero}
						imageAlt={
							subcategory.description ? subcategory.description : 'Tag Image'
						}
						width={1200}
						height={630}
