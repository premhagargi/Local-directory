...
import TagGroupDeleteModal from './TagGroupDeleteModal';
// Import Data
// Import Assets & Icons

export default function TagGroupTable({
	tagGroups,
}: {
	tagGroups:
		| {
	...
	const data = tagGroups === null ? [] : tagGroups;
						...
						<div key={group.id} className="table-row h-auto">
							...
							<div className="table-cell content-center p-2  border-b-2 border-neutral-200">
								<div className="flex gap-2">
									...
									<TagGroupDeleteModal tagGroupId={group.id} />
								</div>
							</div>
						</div>
					))}
